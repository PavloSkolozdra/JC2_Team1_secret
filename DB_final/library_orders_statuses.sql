...
CREATE TABLE `orders_statuses` (
  ...
  `status` enum('PENDING','PROCESSED','CLOSED','REJECTED') NOT NULL DEFAULT 'PENDING',
...
INSERT INTO `orders_statuses` VALUES (1,'PENDING',NULL),(2,'PROCESSED',NULL),(3,'CLOSED',NULL),(4,'REJECTED',NULL);
